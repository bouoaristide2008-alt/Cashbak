...
CANAL_LIEN = "https://t.me/ton_canal"  # Remplace par le lien officiel de ton canal
...
async def support_cmd(message: types.Message):
    ...
    await message.answer("✅ Votre demande de support a été envoyée. L'équipe vous répondra bientôt.")
...
async def id_joueur(message: types.Message):
    ...
    recap = (
        ...
        f"UserID : {user_id}\n\n"
        f"Rejoins le canal officiel [ici]({CANAL_LIEN})"
    )

    # Message récapitulatif
    await message.answer(recap, parse_mode="Markdown")
    await bot.send_message(ADMIN_ID, recap, parse_mode="Markdown")
    await bot.send_message(CHANNEL_ID, recap, parse_mode="Markdown")
